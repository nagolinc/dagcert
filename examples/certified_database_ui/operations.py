...
@operation
def list_items_task(request: ItemsListInput) -> ItemsListed | ItemsListInvalid:
...
@operation
def insert_item_task(request: ItemInsertInput) -> ItemStored | ItemInsertInvalid:
...
@operation
def delete_item_task(request: ItemDeleteInput) -> ItemDeleted:
    with sqlite3.connect(request.path) as connection:
